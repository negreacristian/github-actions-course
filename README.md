...
This is the companion repo to: [GitHub Actions: Beginner to Pro](https://courses.devopsdirective.com/github-actions-beginner-to-pr
...
```bash
git clone --recurse-submodules git@github.com:negreacristian/github-actions-course.git
```
